...
public class ProposerInfo {
	...
	public String toString() {
		return "ProposerInfo [id=" + id + ", proposer=" + proposer + ", email=" + email + ", incity=" + incity
				+ ", ishouseproperty=" + ishouseproperty + ", loanamount=" + loanamount + ", proposerip=" + proposerip
